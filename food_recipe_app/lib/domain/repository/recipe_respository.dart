...
abstract class RecipeRepository {
  ...
  Future<Either<Failure , List<RecipeEntity>>> getRecipesFromIds(List<String> ids);

  Future<Either<Failure , List<RecipeEntity>>> getSavedRecipesSearch(GetRecipesSearchRequestDto request);
  Future<Either<Failure , List<RecipeEntity>>> getLikedRecipesSearch(GetRecipesSearchRequestDto request);
...
class GetRecipesSearchRequestDto{
  ...
  GetRecipesSearchRequestDto({this.searchTerm = "", this.categories = const [], this.page=0});
}
