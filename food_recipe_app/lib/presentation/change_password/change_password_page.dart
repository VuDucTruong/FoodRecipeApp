              ...
              FilledButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      if(!validateMatch(oldPasswordController.text, newPasswordController.text)){
                        showDialog(context: context, builder:
                        (context)=> AppErrorDialog(content: AppStrings.notMatchPass));
                      }
                      else
                      {
                        debugPrint("Change password aslkdjflkasjdl");
                        _changePasswordBloc.add(ChangePasswordSubmitEvent(newPasswordController.text));
                      }
